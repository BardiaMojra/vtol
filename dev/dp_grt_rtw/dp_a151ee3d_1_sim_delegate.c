...
void dp_a151ee3d_1_resetSimStateVector(const void *mech, double *state)
{
  double xx[1];
  (void) mech;
  xx[0] = 0.0;
...
void dp_a151ee3d_1_perturbSimJointPrimitiveState(const void *mech, size_t
...
void dp_a151ee3d_1_perturbFlexibleBodyState(const void *mech, size_t stageIdx,
...
void dp_a151ee3d_1_constructStateVector(const void *mech, const double
...
void dp_a151ee3d_1_extractSolverStateVector(const void *mech, const double
...
boolean_T dp_a151ee3d_1_isPositionViolation(const void *mech, const
...
boolean_T dp_a151ee3d_1_isVelocityViolation(const void *mech, const
  RuntimeDerivedValuesBundle *rtdv, const int *eqnEnableFlags, const double
  *state, const int *modeVector)
{
  const double *rtdvd = rtdv->mDoubles.mValues;
...
PmfMessageId dp_a151ee3d_1_projectStateSim(const void *mech, const
...
void dp_a151ee3d_1_computeConstraintError(const void *mech, const
...
boolean_T dp_a151ee3d_1_hasJointDisToNormModeChange(const void *mech, const int *
...
PmfMessageId dp_a151ee3d_1_performJointDisToNormModeChange(const void *mech,
...
void dp_a151ee3d_1_onModeChangedCutJoints(const void *mech, const int
