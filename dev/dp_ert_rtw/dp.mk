...
%.o : $(START_DIR)/dp_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/dp_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
dp_a151ee3d_1.o : $(START_DIR)/dp_ert_rtw/dp_a151ee3d_1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dp_a151ee3d_1_create.o : $(START_DIR)/dp_ert_rtw/dp_a151ee3d_1_create.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dp_a151ee3d_1_setParameters.o : $(START_DIR)/dp_ert_rtw/dp_a151ee3d_1_setParameters.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dp_a151ee3d_1_asserts.o : $(START_DIR)/dp_ert_rtw/dp_a151ee3d_1_asserts.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dp_a151ee3d_1_deriv.o : $(START_DIR)/dp_ert_rtw/dp_a151ee3d_1_deriv.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dp_a151ee3d_1_checkDynamics.o : $(START_DIR)/dp_ert_rtw/dp_a151ee3d_1_checkDynamics.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dp_a151ee3d_1_compOutputs.o : $(START_DIR)/dp_ert_rtw/dp_a151ee3d_1_compOutputs.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dp_a151ee3d_1_asm_delegate.o : $(START_DIR)/dp_ert_rtw/dp_a151ee3d_1_asm_delegate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dp_a151ee3d_1_sim_delegate.o : $(START_DIR)/dp_ert_rtw/dp_a151ee3d_1_sim_delegate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dp_a151ee3d_1_mode_zero_crossings.o : $(START_DIR)/dp_ert_rtw/dp_a151ee3d_1_mode_zero_crossings.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dp_a151ee3d_1_logging.o : $(START_DIR)/dp_ert_rtw/dp_a151ee3d_1_logging.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dp_a151ee3d_1_geometries.o : $(START_DIR)/dp_ert_rtw/dp_a151ee3d_1_geometries.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dp_a151ee3d_1_gateway.o : $(START_DIR)/dp_ert_rtw/dp_a151ee3d_1_gateway.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_backsubrr_dbl.o : $(START_DIR)/dp_ert_rtw/rt_backsubrr_dbl.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_forwardsubrr_dbl.o : $(START_DIR)/dp_ert_rtw/rt_forwardsubrr_dbl.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_lu_real.o : $(START_DIR)/dp_ert_rtw/rt_lu_real.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_matrixlib_dbl.o : $(START_DIR)/dp_ert_rtw/rt_matrixlib_dbl.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/dp_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
$(MATLAB_ROOT)/extern/physmod/glnxa64/sm_ssci/lib/sm_ssci_ert.a : $(LIBSM_SSCI_ERT_OBJS)
	@echo "### Creating static library $@ ..."
...
$(MATLAB_ROOT)/extern/physmod/glnxa64/ssc_st/lib/ssc_st_ert.a : $(LIBSSC_ST_ERT_OBJS)
	@echo "### Creating static library $@ ..."
...
$(MATLAB_ROOT)/extern/physmod/glnxa64/sm/lib/sm_ert.a : $(LIBSM_ERT_OBJS)
	@echo "### Creating static library $@ ..."
	$(AR) $(ARFLAGS)  $@ $(LIBSM_ERT_OBJS)


$(MATLAB_ROOT)/extern/physmod/glnxa64/pm_math/lib/pm_math_ert.a : $(LIBPM_MATH_ERT_OBJS)
	@echo "### Creating static library $@ ..."
