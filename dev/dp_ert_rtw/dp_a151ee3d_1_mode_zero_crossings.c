...
const NeZCData *dp_a151ee3d_1_ZCData = NULL;
PmfMessageId dp_a151ee3d_1_computeAsmModeVector(const double *input, const
...
PmfMessageId dp_a151ee3d_1_computeSimModeVector(const double *input, const
  double *inputDot, const double *inputDdot, int *modeVector, double
  *errorResult, NeuDiagnosticManager *neDiagMgr)
{
  (void) input;
...
PmfMessageId dp_a151ee3d_1_computeZeroCrossings(const RuntimeDerivedValuesBundle
